...
public class UpdateRetailerAcceptedUseCase extends UseCase<String, DatabaseReference> {

    private static final String TAG = UpdateRetailerAcceptedUseCase.class.getSimpleName();
    private RetailerDealRepository retailerDealRepository;

    @Inject
    protected UpdateRetailerAcceptedUseCase(UseCaseComposer useCaseComposer, RetailerDealRepository retailerDealRepository) {
    ...
    protected Observable<DatabaseReference> createUseCaseObservable(String key, Context context) {
        ...
        return retailerDealRepository.updateRetailerAccepted(key, SharedPrefManager.get_userEmail());
    }
}
