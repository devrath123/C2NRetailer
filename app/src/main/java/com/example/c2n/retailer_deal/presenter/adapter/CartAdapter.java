...
public class CartAdapter extends ExpandableRecyclerAdapter<CartShopViewHolder, CartProductViewHolder> {
    ...
    public CartAdapter(Context context, List<ParentObject> parentItemList, CartAdapterInterface cartAdapterInterface) {
    ...
    public CartShopViewHolder onCreateParentViewHolder(ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.item_retailer_deal, viewGroup, false);
        return new CartShopViewHolder(view, cartAdapterInterface);
    }
    ...
    public void onBindParentViewHolder(CartShopViewHolder holder, int i, Object o) {
        ...
        holder.textViewDeclineDeal.setVisibility(View.VISIBLE);
        if (shop.getStatus().equals("accepted")) {
            holder.textViewDeclineDeal.setVisibility(View.GONE);
            holder.textViewAcceptDeal.setText("Accepted");
        } else if (shop.getStatus().equals("declined")) {
            holder.textViewDeclineDeal.setVisibility(View.GONE);
            holder.textViewAcceptDeal.setText("Declined");
        }
        ...
        holder.requestedDeal.setText("Requested : " + shop.getDiscount() + "%");
        holder.textViewCustomerName.setText(shop.getUserName());
        ...
        holder.textViewAcceptDeal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (shop.getStatus().equals("proposed")) {
                    holder.textViewAcceptDeal.setText("Accepted");
                    cartAdapterInterface.acceptDeal(shop);
                }
            }
        });
        holder.textViewDeclineDeal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                holder.textViewAcceptDeal.setText("Declined");
                holder.textViewDeclineDeal.setVisibility(View.GONE);
                cartAdapterInterface.declineDeal(shop);
            }
        });
    }
