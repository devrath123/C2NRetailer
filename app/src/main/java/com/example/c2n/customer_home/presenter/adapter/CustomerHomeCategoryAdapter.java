...
public class CustomerHomeCategoryAdapter extends RecyclerView.Adapter<CustomerHomeCategoryAdapter.ViewHolder> {

    private int mClickedPosition = -1;
    private int previousClickedPosition = -1;
    private int selectedItem;

    private CustomerHomeCategoryInterface customerHomeCategoryInterface;
    private List<CategoryDataModel> categoryDataModels;
    private Context context;

    public CustomerHomeCategoryAdapter(List<CategoryDataModel> categoryDataModels, Context context, CustomerHomeCategoryInterface customerHomeCategoryInterface) {
        this.categoryDataModels = categoryDataModels;
        this.context = context;
        this.customerHomeCategoryInterface = customerHomeCategoryInterface;
        selectedItem = 0;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CustomerHomeCategoryAdapter.ViewHolder(itemView, customerHomeCategoryInterface);
    }
...
//            holder.textViewCategoryName.setBackgroundColor(R.color.backgroundOrange);
        ...
        holder.linearLayoutCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customerHomeCategoryInterface.categoryClicked(categoryDataModel.getCategoryName());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, CustomerHomeCategoryInterface customerHomeCategoryInterface) {
            super(itemView);
    ...
    public interface CustomerHomeCategoryInterface {
