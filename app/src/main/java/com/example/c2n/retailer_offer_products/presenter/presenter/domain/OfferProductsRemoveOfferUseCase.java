...
public class OfferProductsRemoveOfferUseCase extends UseCase<Object[], Boolean> {

    OfferProductsRepository offerProductsRepository;

    @Inject
    protected OfferProductsRemoveOfferUseCase(UseCaseComposer useCaseComposer, OfferProductsRepository offerProductsRepository) {
...
//        Log.d("OfferProductsUseCase_", "" + "in update offer use case " + productDataModelList.toString());
        ...
        return offerProductsRepository.removeOffers(objects, SharedPrefManager.get_userDocumentID());
    }
}
