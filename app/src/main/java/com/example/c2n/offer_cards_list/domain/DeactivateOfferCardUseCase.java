...
public class DeactivateOfferCardUseCase extends UseCase<String, Boolean> {
    OffersRepository offersRepository;

    @Inject
    protected DeactivateOfferCardUseCase(UseCaseComposer useCaseComposer, OffersRepository offersRepository) {
    ...
    protected Observable<Boolean> createUseCaseObservable(String offerDocumentId, Context context) {
        ...
        return offersRepository.deactivateOfferCard(SharedPrefManager.get_userDocumentID(), offerDocumentId);
    }
}
