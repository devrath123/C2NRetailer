...
public class AddCustomerFromRetailerUseCase extends UseCase<CustomerDataModel, DocumentReference> {
    LoginRepository loginRepository;

    @Inject
    protected AddCustomerFromRetailerUseCase(UseCaseComposer useCaseComposer, LoginRepository loginRepository) {
    ...
    protected Observable<DocumentReference> createUseCaseObservable(CustomerDataModel customer, Context context) {
        return loginRepository.addCustomerFromRetailer(customer);
    }
}
